...
azure-secrets:
	...
	oc create secret generic aos-azure-github-ssh-secret --from-file=cluster/test-deploy/azure/ssh-privatekey --from-file=ssh-publickey=cluster/test-deploy/azure/ssh-privatekey.pub -n azure
.PHONY: azure-secrets
