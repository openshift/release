...
postsubmit-update: prow-services origin-release libpod prow-monitoring build-dashboards-validation-image image-mirror-setup knative-image-mirror-setup tekton-image-mirror-setup kubefed-image-mirror-setup cincinnati
...
projects: ci-ns gcsweb origin-stable origin-release image-mirror-setup knative-image-mirror-setup tekton-image-mirror-setup kubefed-image-mirror-setup image-pruner-setup publishing-bot content-mirror azure python-validation metering
.PHONY: projects
