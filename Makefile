...
export DEFAULT_CONTAINER_ENGINE ?= $(shell (command -v podman 2>&1 >/dev/null && echo podman) || echo docker)
export CONTAINER_ENGINE ?= $(DEFAULT_CONTAINER_ENGINE)
