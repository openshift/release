...
1. [`interop-tests-fusion-access-core-deployment-chain`](../../../step-registry/interop-tests/fusion-access/core-deployment-chain/interop-tests-fusion-access-core-deployment-chain-chain.yaml) - Core deployment chain
2. [`interop-tests-fusion-access-ebs-deployment`](../../../step-registry/interop-tests/fusion-access/ebs-deployment/interop-tests-fusion-access-ebs-deployment-chain.yaml) - EBS filesystem deployment
3. [`interop-tests-fusion-access-tests`](../../../step-registry/interop-tests/fusion-access/tests/interop-tests-fusion-access-tests-ref.yaml) - Execute Fusion Access tests
4. [`interop-tests-fusion-access-custom-ibm-must-gather`](../../../step-registry/interop-tests/fusion-access/custom-ibm-must-gather/interop-tests-fusion-access-custom-ibm-must-gather-ref.yaml) - Collect IBM-specific diagnostics
