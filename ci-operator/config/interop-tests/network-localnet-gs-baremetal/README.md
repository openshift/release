...
- [Process](#process)
  ...
  - [Test Setup, Execution, and Reporting Results -`interop-tests-network-localnet-gs-baremetal`](#test-setup-execution-and-reporting-results--interop-tests-network-localnet-gs-baremetal)
...
The [`external-cluster`](../../../step-registry/interop-tests/network-localnet-gs-baremetal/README.md) workflow imports KUBECONFIG file of a cluster that was deployed outside CI Operator.

### Test Setup, Execution, and Reporting Results -`interop-tests-network-localnet-gs-baremetal`

Following the test cluster setup, the following steps are executed:
- [`interop-tests-network-localnet-gs-baremetal`](../../../step-registry/interop-tests/network-localnet-gs-baremetal/README.md)
