...
# Export credentials (Vertex AI env vars are set automatically via ref YAML)
...
while IFS= read -r line; do
  ...
  # Using explicit tool allowlist instead of --dangerously-skip-permissions for CI safety
