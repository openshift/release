...
set +e
run_claude_metered "$USER_PROMPT" "${ARTIFACT_DIR}/claude-failure-analysis.json" \
...
# Emit Claude session cost/token metrics autodl (best-effort; never fails the step)
