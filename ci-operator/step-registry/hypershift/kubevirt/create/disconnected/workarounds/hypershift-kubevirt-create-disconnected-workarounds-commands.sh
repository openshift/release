...
if [[ -z ${MCE} ]] ; then
  ...
  oc image -a /home/pull-secret-mirror mirror quay-proxy.ci.openshift.org/openshift/ci:ocp_${CNV_PRERELEASE_VERSION}_cluster-api-provider-kubevirt ${mirror_registry}/${LOCALIMAGES}/${CNV_PRERELEASE_VERSION}:cluster-api-provider-kubevirt
