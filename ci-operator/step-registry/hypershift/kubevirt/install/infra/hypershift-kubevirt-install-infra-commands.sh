...
# Keep in sync with hypershift-kubevirt-install-commands.sh (step-registry cannot share
# commands across refs at runtime). .value // "" avoids literal "null" from valueFrom.
