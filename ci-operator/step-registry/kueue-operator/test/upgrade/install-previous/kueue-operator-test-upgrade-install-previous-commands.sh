...
CHANNEL="${KUEUE_PREVIOUS_CHANNEL:-stable-v1.3}"

echo "Installing previous kueue operator release from ${CATSRC_NAME}, channel ${CHANNEL}..."
...
echo "Previous kueue operator release (${CHANNEL}) installed successfully."
