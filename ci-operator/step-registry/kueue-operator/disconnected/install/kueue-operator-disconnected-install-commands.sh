...
mirror:
  ...
  - name: ${OPERATOR_IMAGE_FROM_CSV}
  - name: ${OPERAND_IMAGE_FROM_CSV}
...
spec:
  imageDigestMirrors:
    - mirrors:
        - ${MIRROR_REGISTRY_HOST}/kueue/kueue-rhel9-operator
      source: registry.redhat.io/kueue/kueue-rhel9-operator
    - mirrors:
        - ${MIRROR_REGISTRY_HOST}/kueue/kueue-rhel9
      source: registry.redhat.io/kueue/kueue-rhel9
    - mirrors:
        - ${MIRROR_REGISTRY_HOST}/kueue/kueue-must-gather-rhel9
