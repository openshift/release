...
SELINUX_RPM=$(readlink -f /go/src/github.com/redhat-et/microshift/selinux-rpm/*.rpm | head -n 1)
MICROSHIFT_RPM=$(readlink -f /go/src/github.com/redhat-et/microshift/microshift-rpm/*.rpm | head -n 1)
