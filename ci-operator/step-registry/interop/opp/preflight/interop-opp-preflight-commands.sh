...
OPP_COMPAT["5.0"]="advanced-cluster-management:2.17 quay-operator:3.17 odf-operator:4.22 rhacs-operator:4.11"
OPP_COMPAT["5.1"]="advanced-cluster-management:2.17 quay-operator:3.17"
