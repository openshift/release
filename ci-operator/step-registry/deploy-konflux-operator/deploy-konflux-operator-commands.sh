...
function set_proxy () {
    if test -s "${SHARED_DIR}/proxy-conf.sh" ; then
        ...
        export no_proxy=mirror.openshift.com,openshift-mirror-list.ci-systems.workers.dev,registry.stage.redhat.io,registry.redhat.io,registry.ci.openshift.org,quay.io,s3.us-east-1.amazonaws.com
        export NO_PROXY=mirror.openshift.com,openshift-mirror-list.ci-systems.workers.dev,registry.stage.redhat.io,registry.redhat.io,registry.ci.openshift.org,quay.io,s3.us-east-1.amazonaws.com
    else
