...
cd ${workdir}
oc image extract "registry.build06.ci.openshift.org/ci-ln-ss2vbht/stable@sha256:7f3ae4d23d52096b50023bdaff85b375ca8be3303247ddbb554653bbc8d16692" --path=/usr/bin/oc-mirror:.
