...
📊 [**View Logs**](https://gcs.ci.openshift.org/gcs/test-platform-results-public/pr-logs/pull/${URL_REPO}/${PULL_NUMBER}/${JOB_NAME}/${BUILD_ID}/artifacts/deploy/redhat-developer-rhdh-test-instance/build-log.txt) for details"
