...
mapt aws eks create \
  ...
  --tags app-code=rhdh-003,service-phase=dev,cost-center=726,scenario=eks,origin=mapt,architecture=x86_64,cluster-type=k8s,pipeline=openshift-ci,job-name=${JOB_NAME}
