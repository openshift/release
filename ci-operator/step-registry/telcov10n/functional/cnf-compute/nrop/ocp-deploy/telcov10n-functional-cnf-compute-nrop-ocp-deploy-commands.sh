...
EXTRA_VARS="${EXTRA_VARS} release=${VERSION}"
EXTRA_VARS="${EXTRA_VARS} cluster_name=${CLUSTER_NAME}"
EXTRA_VARS="${EXTRA_VARS} ocp_version_facts_dev_version=${OCP_VERSION_RELEASE_TYPE}"
...
EXTRA_VARS="${EXTRA_VARS} cpu_partitioning=${WORKLOAD_PARTITIONING}"

export ANSIBLE_FORKS=2
export ANSIBLE_PIPELINING=true

echo "Deploy SNO OCP for cnf-compute-nrop testing"
