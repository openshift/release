...
# fthub-01, kni-qe-106, kni-qe-110, and kni-qe-127 share the same hypervisor (helix107), but ci-operator
# cannot mount the same secret twice.
if [ "${CLUSTER_NAME}" = "kni-qe-106" ] || [ "${CLUSTER_NAME}" = "kni-qe-110" ] || [ "${CLUSTER_NAME}" = "kni-qe-127" ]; then
