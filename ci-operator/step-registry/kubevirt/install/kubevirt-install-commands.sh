...
oc -n openshift-monitoring exec -ti alertmanager-main-0 -c alertmanager -- amtool silence add alertname=CDIDefaultStorageClassDegraded --alertmanager.url=http://localhost:9093 --duration="300d" --comment="OCPKubeVirt no ReadWriteMany storage class"
