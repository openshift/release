...
TEST_LABEL_FILTER="${RUN_TIME}&&!Exclude" # required before prow_ci enhanced the LABEL_FILTER in generate_label_filter_switch
FOCUS="" # leave it for further usage
LABEL_FILTER_SWITCH=""
