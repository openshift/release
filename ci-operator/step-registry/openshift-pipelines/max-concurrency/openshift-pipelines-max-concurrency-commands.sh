...
for scenario in "900/90"; do
    ...
    oc -n benchmark get pods -o yaml >"$artifacts/pods.yaml"
    oc -n benchmark get taskruns -o yaml >"$artifacts/taskruns.yaml"
    oc -n benchmark get pipelineruns -o yaml >"$artifacts/pipelineruns.yaml"
    oc delete namespace/benchmark
    sleep 60
done
