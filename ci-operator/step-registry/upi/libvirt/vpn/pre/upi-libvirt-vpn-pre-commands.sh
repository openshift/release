...
REMOTE_LIBVIRT_URI="qemu+tcp://10.0.1.2/system"
echo "Run 'mock-nss.sh virsh -c qemu+tcp://10.0.1.2/system list' to test the libvirt connection for $REMOTE_LIBVIRT_URI"
