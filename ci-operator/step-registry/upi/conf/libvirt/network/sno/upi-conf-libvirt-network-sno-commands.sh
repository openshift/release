...
echo "Creating the SNO libvirt network.xml file..."

# Force the rendezvous host onto the bootstrap IP so debug logs can use the
# existing SSH tunnel from libvirt IPI/UPI workflows.
