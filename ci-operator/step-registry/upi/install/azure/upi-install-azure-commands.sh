...
if [ -v vnet_basename ] && [ -n "${vnet_basename}" ]; then
  echo "Using an existing vnet, so use a customized infra file"
...
if [ -v vnet_basename ] && [ -n "${vnet_basename}" ]; then
  echo "Using an existing vnet, so use a customized bootstrap file"
...
if [ -v vnet_basename ] && [ -n "${vnet_basename}" ]; then
  echo "Using an existing vnet, so use a customized master file"
...
if [ -v vnet_basename ] && [ -n "${vnet_basename}" ]; then
  echo "Using an existing vnet, so use a customized worker file"
