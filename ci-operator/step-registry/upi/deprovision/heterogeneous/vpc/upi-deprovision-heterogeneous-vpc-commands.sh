...
# Delete the  Multi-Arch Compute VPC resources
...
then
  echo "Starting the delete on the Multi-Arch Compute VPC resources"
...
echo "IBM Cloud  Multi-Arch Compute VPC resources destroyed successfully $(date)"
