...
# Align with the known-good ppc64le RHCL stack: OSSM 3.x Sail with
...
# Working RHCL ppc64le clusters co-locate IstioCNI with the Sail operator namespace.
cat <<EOF | oc apply -f -
...
# reference (hub/tag are ignored) - required for ppc64le proxy builds.
PROXY_VALUES=""
