...
curl -L https://raw.githubusercontent.com/yunjiang29/ocp-test-data/main/upi_on_aws-cloudformation-templates/01_vpc_disconnected_aws_with_privatelink.yaml -o ${vpc_tpl}
