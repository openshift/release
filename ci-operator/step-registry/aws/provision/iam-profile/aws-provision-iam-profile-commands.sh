...
# Optionally create a dedicated BYO IAM role/policy/instance-profile for the edge
# compute pool (AWS Local/Wavelength zones).
if [[ "${PROVISION_EDGE_IAM_PROFILE:-no}" == "yes" ]]; then
