...
DISABLED_MONITOR_TESTS="apiserver-availability,apiserver-new-disruption-invariant,disruption-summary-serializer,external-service-availability,image-registry-availability,ingress-availability,pod-network-avalibility,service-type-load-balancer-availability"
