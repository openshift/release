...
function get_source_dir() {
  declare -A SCENARIO_DIRS=(
    ...
    [bootc-releases-el96]="scenarios-bootc/el96/releases:scenarios-bootc"
    [bootc-releases-el100]="scenarios-bootc/el100/releases:scenarios-bootc"
    [bootc-presubmits-el96]="scenarios-bootc/el96/presubmits:scenarios-bootc"
    [bootc-presubmits-el100]="scenarios-bootc/el100/presubmits:scenarios-bootc"
    [bootc-periodics-el96]="scenarios-bootc/el96/periodics:scenarios-bootc"
    [bootc-periodics-el100]="scenarios-bootc/el100/periodics:scenarios-bootc"
