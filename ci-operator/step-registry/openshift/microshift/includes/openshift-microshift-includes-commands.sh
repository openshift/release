...
function get_source_dir() {
  declare -A SCENARIO_DIRS=(
    ...
    [bootc-presubmits-el96]="scenarios-bootc/presubmits/el96:scenarios-bootc"
    [bootc-periodics-el96]="scenarios-bootc/periodics/el96:scenarios-bootc"
    [bootc-presubmits-el100]="scenarios-bootc/presubmits/el100:scenarios-bootc"
    [bootc-periodics-el100]="scenarios-bootc/periodics/el100:scenarios-bootc"
