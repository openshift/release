...
# Disable CPU pinning for other services
ssh "${INSTANCE_PREFIX}" "sudo rm -f /etc/systemd/system/{ovs-vswitchd,ovsdb-server}.service.d/microshift-cpuaffinity.conf"
