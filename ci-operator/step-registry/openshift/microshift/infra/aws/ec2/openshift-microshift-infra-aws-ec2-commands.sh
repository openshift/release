...
declare -A ami_map=(
  ...
  [us-west-2,arm64,rhel-9.4]=ami-036d52dc86a04b099     # RHEL-9.4.0_HVM-20240423-arm64-62-Hourly2-GP3
  [us-west-2,x86_64,rhel-9.4]=ami-0a04d3220939627d1     # RHEL-9.4.0_HVM-20240423-x86_64-62-Hourly2-GP3
)
