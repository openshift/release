...
# For now keep it simple to US. If price becomes a concern we can intersperse EU regions, which are
# somewhere in between the cheapest and most expensive in US.
declare regions=(us-east-2 us-east-1 us-west-2 us-west-1)
