...
if [[ -f "${WEBHOOK_FILE}" ]] && [[ "${JOB_TYPE:-}" == "periodic" ]]; then
    ...
    MESSAGE=":robot_face: *LVMS CI Doctor* report available. | <${REPORT_URL}|Report> | <https://prow.ci.openshift.org/view/gs/test-platform-results-public/logs/${JOB_NAME}/${BUILD_ID}|Logs> |"
