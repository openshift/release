...
run-on-all-nodes "sed -i -e 's/.*ClientAliveInterval.*/ClientAliveInterval 90/g' /etc/ssh/sshd_config && sed -i -e 's/.*ClientAliveMax.*/ClientAliveMax 100/g' /etc/ssh/sshd_config"
set +e
