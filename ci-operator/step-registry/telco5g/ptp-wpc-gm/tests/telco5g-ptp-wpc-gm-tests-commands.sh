...
export CURRENTGMNODE="cnfdf32.telco5gran.eng.rdu2.redhat.com"
...
jobdefinition=$(sed "s#CURRENTGMNODE#${CURRENTGMNODE}#" <<< "$jobdefinition")
echo "$jobdefinition" | oc apply -f -
