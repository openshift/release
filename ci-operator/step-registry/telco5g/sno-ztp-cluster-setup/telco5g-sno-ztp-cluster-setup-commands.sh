...
cp $SHARED_DIR/inventory $ARTIFACT_DIR/inventory_x
# shellcheck disable=SC1083
data=$(ansible hypervisor -m shell -a "host $SNO_NAME" | grep address)
...
cp $SHARED_DIR/mgmt-kubeconfig ${ARTIFACT_DIR}/mgmt-kubeconfig
