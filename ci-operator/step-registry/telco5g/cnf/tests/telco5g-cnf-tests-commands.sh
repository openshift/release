...
git -c user.name="CI User" -c user.email=cnf-devel@redhat.com fetch origin pull/1439/head:pull_1439
git -c user.name="CI User" -c user.email=cnf-devel@redhat.com checkout pull_1439
