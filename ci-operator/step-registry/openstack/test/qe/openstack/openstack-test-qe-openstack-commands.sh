...
curl "${OCP_TESTING_URL}/${JOB_NUMBER}/artifact/openstack-test-results/manilacsi-test.log" > "${ARTIFACT_DIR}/e2e.log"

curl -o "${ARTIFACT_DIR}/junit.zip" "${OCP_TESTING_URL}/${JOB_NUMBER}/artifact/openstack-test-results/*zip*/openstack-test-results.zip"
