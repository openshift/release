...
oc --insecure-skip-tls-verify adm must-gather \
    ...
    --dest-dir ${ARTIFACT_DIR}/must-gather -- ADDITIONAL_NAMESPACES=kuttl,sushy-emulator,crc-storage OMC=false gather &> ${ARTIFACT_DIR}/must-gather/openstack-must-gather.log
