...
echo "##################################"
echo "##################################"
oc get csv openstack-operator.v0.0.1 -o yaml
echo "##################################"
oc get subscription openstack-operator -o yaml
echo "##################################"
oc get catalogsource openstack-operator-index -o yaml
echo "##################################"
oc get pods | grep openstack-operator | awk '{print $1}' | xargs oc get pods -o yaml |less
echo "##################################"
echo "##################################"
