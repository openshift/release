...
function patch_custom_tlssecurityprofile_config(){
    local logging_tls_profile_json="$1"
    local logging_tls_profile_type="$2"
...
patch_custom_tlssecurityprofile_config "$LOGGING_CUSTOM_TLS_PROFILE_CONFIG" "$LOGGING_TLS_PROFILE_TYPE"
