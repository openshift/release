...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/{{ release_version }}/rhel-server-ose-rpms/
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/ci-deps/rhel-server-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
failovermethod = priority
gpgcheck = 0
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/ci-deps/rhel-server-optional-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
failovermethod = priority
gpgcheck = 0
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/ci-deps/rhel-server-extras-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
failovermethod = priority
gpgcheck = 0
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/ci-deps/rhel-fast-datapath-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
failovermethod = priority
gpgcheck = 0
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/{{ release_version }}/rhel-8-server-ose-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
failovermethod = priority
gpgcheck = 0
...
name = A repository of dependencies for OpenShift Container Platform {{ release_version }}
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/{{ release_version }}/rhel-8-fast-datapath-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
failovermethod = priority
gpgcheck = 0
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/ci-deps/rhel-8-baseos-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
gpgcheck = 0
sslverify = 0
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/ci-deps/rhel-8-appstream-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
gpgcheck = 0
sslverify = 0
...
name = A repository of dependencies for OpenShift Container Platform {{ release_version }}
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/{{ release_version }}/rhel-9-server-ose-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
failovermethod = priority
gpgcheck = 0
...
name = A repository of dependencies for OpenShift Container Platform {{ release_version }}
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/{{ release_version }}/rhel-9-fast-datapath-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
failovermethod = priority
gpgcheck = 0
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/ci-deps/rhel-9-baseos-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
gpgcheck = 0
sslverify = 0
...
baseurl = https://openshift-mirror-list.ci-systems.workers.dev/enterprise/reposync/ci-deps/rhel-9-appstream-rpms/
username = {{ mirror_username }}
password = {{ mirror_password }}
gpgcheck = 0
sslverify = 0
