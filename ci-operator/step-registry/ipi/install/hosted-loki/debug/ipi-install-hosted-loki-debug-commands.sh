...
data:
  promtail.yaml: |-
    ...
    - job_name: prometheus-adapter-audit
      static_configs:
      - targets:
        - localhost
        labels:
          audit: prometheus-adapter
          __path__: /var/log/prometheus-adapter/prometheus-adapter-audit.log
    server:
    ...
    spec:
      ...
      - command:
        ...
        - mountPath: "/var/log/journal"
          name: journal
          readOnly: true
        - mountPath: "/var/log/prometheus-adapter"
          name: auditlogs-prometheus-adapter
          readOnly: true
      - args:
        - --https-address=:9001
        - --provider=openshift
