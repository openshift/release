...
vpc_id=$(aws ec2 describe-vpcs --filters Name=tag:"Name",Values="Nutanix Cluster 2C2AD7AC4CDA" --query 'Vpcs[0].VpcId' --output text)
vmc_subnet="subnet-01407e6cb1d260f13"
...
aws elbv2 register-targets \
    ...
    --targets Id="${vips[1]}",Port=80,AvailabilityZone="us-east-2a"

aws elbv2 register-targets \
    --target-group-arn ${https_tg_arn} \
    --targets Id="${vips[1]}",Port=443,AvailabilityZone="us-east-2a"

aws elbv2 register-targets \
    --target-group-arn ${api_tg_arn} \
    --targets Id="${vips[0]}",Port=6443,AvailabilityZone="us-east-2a"
