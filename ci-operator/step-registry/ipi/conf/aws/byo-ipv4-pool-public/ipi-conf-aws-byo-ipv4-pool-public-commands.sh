...
cat > "${ARTIFACT_DIR}/manifest_cluster-ingress-default-ingresscontroller.yaml" << EOF
...
#cp "${ARTIFACT_DIR}/manifest_cluster -ingress-default-ingresscontroller.yaml" "${SHARED_DIR}/manifest_cluster-ingress-default-ingresscontroller.yaml"
