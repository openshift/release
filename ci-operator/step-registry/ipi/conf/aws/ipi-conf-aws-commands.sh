...
# Add platform.aws.defaultMachinePlatform.type support
if [[ "${DEFAULT_INSTANCE_TYPE}" != "" ]]; then
  yq-go write -i "${CONFIG}" "platform.aws.defaultMachinePlatform.type" "${DEFAULT_INSTANCE_TYPE}"
fi
