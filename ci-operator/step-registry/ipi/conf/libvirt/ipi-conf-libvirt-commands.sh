...
# sshd-bastion services
#if [[ "${ARCH}" == "s390x" ]]; then
#  REMOTE_LIBVIRT_HOSTNAME=172.30.104.249
#  REMOTE_LIBVIRT_HOSTNAME_1=172.30.206.45
#  REMOTE_LIBVIRT_HOSTNAME_2=172.30.104.249
#fi

#if [[ "${ARCH}" == "ppc64le" ]]; then
#  REMOTE_LIBVIRT_HOSTNAME=172.30.215.37
#  REMOTE_LIBVIRT_HOSTNAME_1=172.30.200.775
#  REMOTE_LIBVIRT_HOSTNAME_2=172.30.230.155
#fi
