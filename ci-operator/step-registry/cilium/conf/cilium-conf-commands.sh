...
curl --fail --retry 3 -sS -L \
  "https://github.com/cilium/cilium-cli/releases/download/v${CILIUM_CLI_VERSION}/cilium-linux-amd64.tar.gz.sha256sum" \
  -o /tmp/cilium-linux-amd64.tar.gz.sha256sum
