...
get_nameservers() {
    local DNS_DATA
    local URL1="https://github.com/openshift/release/blob/main/clusters/build-clusters/build10/openshift-dns/dns.yaml"
    local URL='https://raw.githubusercontent.com/openshift/release/refs/heads/main/clusters/build-clusters/build10/openshift-dns/dns.yaml'
