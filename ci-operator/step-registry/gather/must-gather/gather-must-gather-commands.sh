...
function installCamgi() {
    ...
    curl -vLO 'https://gist.github.com/danilo-gemoli/b0ec0edd6d98b4a3e73a30722f1add50/raw/fca057273ccb362654be1394bbce589f53544adf/camgi-b64'
    base64 -d camgi-b64 >camgi
    chmod +x camgi
