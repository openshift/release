...
${t_all}     cluster:usage:cpu:kube_apiserver:total:avg   avg(sum(rate(container_cpu_usage_seconds_total{container="kube-apiserver", namespace="openshift-kube-apiserver"}[${d_all}])) by (pod))
${t_install} cluster:usage:cpu:kube_apiserver:install:avg avg(sum(rate(container_cpu_usage_seconds_total{container="kube-apiserver", namespace="openshift-kube-apiserver"}[${d_install}])) by (pod))
${t_test}    cluster:usage:cpu:kube_apiserver:test:avg    avg(sum(rate(container_cpu_usage_seconds_total{container="kube-apiserver", namespace="openshift-kube-apiserver"}[${d_test}])) by (pod))

${t_all}     cluster:usage:cpu:apiserver:total:seconds:quantile label_replace(quantile_over_time(.95,sum(irate(container_cpu_usage_seconds_total{{container="kube-apiserver", namespace="openshift-kube-apiserver"}[90s:30s]))[${d_all}:]),"quantile","0.95","","")
${t_install} cluster:usage:cpu:apiserver:install:seconds:quantile label_replace(quantile_over_time(.95,sum(irate(container_cpu_usage_seconds_total{{container="kube-apiserver", namespace="openshift-kube-apiserver"}[90s:30s]))[${d_all}:${d_test}]),"quantile","0.95","","")
${t_test}    cluster:usage:cpu:apiserver:test:seconds:quantile label_replace(quantile_over_time(.95,sum(irate(container_cpu_usage_seconds_total{{container="kube-apiserver", namespace="openshift-kube-apiserver"}[90s:30s]))[${d_test}:]),"quantile","0.95","","")

${t_all}     cluster:usage:cpu:etcd:total:avg   avg(sum(rate(container_cpu_usage_seconds_total{container="etcd", namespace="openshift-etcd"}[${d_all}])) by (pod))
${t_install} cluster:usage:cpu:etcd:install:avg avg(sum(rate(container_cpu_usage_seconds_total{container="etcd", namespace="openshift-etcd"}[${d_install}])) by (pod))
${t_test}    cluster:usage:cpu:etcd:test:avg    avg(sum(rate(container_cpu_usage_seconds_total{container="etcd", namespace="openshift-etcd"}[${d_test}])) by (pod))

${t_all}     cluster:usage:cpu:openshift_apiserver:total:avg   avg(sum(rate(container_cpu_usage_seconds_total{container="openshift-apiserver", namespace="openshift-apiserver"}[${d_all}])) by (pod))
${t_install} cluster:usage:cpu:openshift_apiserver:install:avg avg(sum(rate(container_cpu_usage_seconds_total{container="openshift-apiserver", namespace="openshift-apiserver"}[${d_install}])) by (pod))
${t_test}    cluster:usage:cpu:openshift_apiserver:test:avg    avg(sum(rate(container_cpu_usage_seconds_total{container="openshift-apiserver", namespace="openshift-apiserver"}[${d_test}])) by (pod))

${t_all}     cluster:usage:cpu:oauth_apiserver:total:avg   avg(sum(rate(container_cpu_usage_seconds_total{container="oauth-apiserver", namespace="openshift-oauth-apiserver"}[${d_all}])) by (pod))
${t_install} cluster:usage:cpu:oauth_apiserver:install:avg avg(sum(rate(container_cpu_usage_seconds_total{container="oauth-apiserver", namespace="openshift-oauth-apiserver"}[${d_install}])) by (pod))
${t_test}    cluster:usage:cpu:oauth_apiserver:test:avg    avg(sum(rate(container_cpu_usage_seconds_total{container="oauth-apiserver", namespace="openshift-oauth-apiserver"}[${d_test}])) by (pod))
...
${t_all}     cluster:usage:memory:kube_apiserver:total:avg   avg(sum(container_memory_working_set_bytes{pod=~"kube-apiserver-ip.*", namespace="openshift-kube-apiserver"}[${d_all}]) by (pod))
${t_install} cluster:usage:memory:kube_apiserver:install:avg avg(sum(container_memory_working_set_bytes{pod=~"kube-apiserver-ip.*", namespace="openshift-kube-apiserver"}[${d_install}]) by (pod))
${t_test}    cluster:usage:memory:kube_apiserver:test:avg    avg(sum(container_memory_working_set_bytes{pod=~"kube-apiserver-ip.*", namespace="openshift-kube-apiserver"}[${d_test}]) by (pod))

${t_all}     cluster:usage:memory:etcd:total:avg   avg(sum(container_memory_working_set_bytes{pod=~"etcd-ip-.*", namespace="openshift-etcd"}[${d_all}]) by (pod))
${t_install} cluster:usage:memory:etcd:install:avg avg(sum(container_memory_working_set_bytes{pod=~"etcd-ip.*", namespace="openshift-etcd"}[${d_install}]) by (pod))
${t_test}    cluster:usage:memory:etcd:test:avg    avg(sum(container_memory_working_set_bytes{pod=~"etcd-ip.*", namespace"openshift-etcd"}[${d_test}]) by (pod))

${t_all}     cluster:usage:memory:openshift_apiserver:total:avg   avg(sum(container_memory_working_set_bytes{pod=~"apiserver-.*", namespace="openshift-apiserver"}[${d_all}]) by (pod))
${t_install} cluster:usage:memory:openshift_apiserver:install:avg avg(sum(container_memory_working_set_bytes{pod=~"apiserver-.*", namespace="openshift-apiserver"}[${d_install}]) by (pod))
${t_test}    cluster:usage:memory:openshift_apiserver:test:avg    avg(sum(container_memory_working_set_bytes{pod=~"apiserver-.*", namespace="openshift-apiserver"}[${d_test}]) by (pod))

${t_all}     cluster:usage:memory:oauth_apiserver:total:avg   avg(sum(container_memory_working_set_bytes{pod=~"apiserver-.*", namespace="openshift-oauth-apiserver"}[${d_all}]) by (pod))
${t_install} cluster:usage:memory:oauth_apiserver:install:avg avg(sum(container_memory_working_set_bytes{pod=~"apiserver-.*", namespace="openshift-oauth-apiserver"}[${d_install}]) by (pod))
${t_test}    cluster:usage:memory:oauth_apiserver:test:avg    avg(sum(container_memory_working_set_bytes{pod=~"apiserver-.*", namespace="openshift-oauth-apiserver"}[${d_test}]) by (pod))
...
${t_all}     cluster:api:read:requests:latency:total:quantile histogram_quantile(0.99, sum(rate(apiserver_request_duration_seconds_bucket{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_all}])) by (le,scope))
${t_install} cluster:api:read:requests:latency:install:quantile histogram_quantile(0.99, sum(rate(apiserver_request_duration_seconds_bucket{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_install}])) by (le,scope))
${t_test}    cluster:api:read:requests:latency:test:quantile histogram_quantile(0.99, sum(rate(apiserver_request_duration_seconds_bucket{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_test}])) by (le,scope))
${t_all}     cluster:api:write:requests:latency:total:quantile histogram_quantile(0.99, sum(rate(apiserver_request_duration_seconds_bucket{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_all}])) by (le,scope))
${t_install} cluster:api:write:requests:latency:install:quantile histogram_quantile(0.99, sum(rate(apiserver_request_duration_seconds_bucket{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_install}])) by (le,scope))
${t_test}    cluster:api:write:requests:latency:test:quantile histogram_quantile(0.99, sum(rate(apiserver_request_duration_seconds_bucket{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_test}])) by (le,scope))

${t_all}     cluster:api:read:requests:latency:total:avg sum(rate(apiserver_request_duration_seconds_sum{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_all}])) by (scope) / sum(rate(apiserver_request_duration_seconds_count{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_all}])) by (scope)
${t_install} cluster:api:read:requests:latency:install:avg sum(rate(apiserver_request_duration_seconds_sum{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_install}])) by (scope) / sum(rate(apiserver_request_duration_seconds_count{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_install}])) by (scope)
${t_test}    cluster:api:read:requests:latency:test:avg sum(rate(apiserver_request_duration_seconds_sum{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_test}])) by (scope) / sum(rate(apiserver_request_duration_seconds_count{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"GET|LIST"}[${d_test}])) by (scope)
${t_all}     cluster:api:write:requests:latency:total:avg sum(rate(apiserver_request_duration_seconds_sum{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_all}])) by (scope) / sum(rate(apiserver_request_duration_seconds_count{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_all}])) by (scope)
${t_install} cluster:api:write:requests:latency:install:avg sum(rate(apiserver_request_duration_seconds_sum{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_install}])) by (scope) / sum(rate(apiserver_request_duration_seconds_count{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_install}])) by (scope)
${t_test}    cluster:api:write:requests:latency:test:avg sum(rate(apiserver_request_duration_seconds_sum{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_test}])) by (scope) / sum(rate(apiserver_request_duration_seconds_count{job="apiserver",scope!="",subresource!~"proxy|attach|log|exec|portforward",verb=~"POST|PUT|PATCH|DELETE"}[${d_test}])) by (scope)
...
${t_all}     cluster:etcd:read:requests:latency:total:quantile histogram_quantile(0.99, sum(rate(etcd_request_duration_seconds_bucket{operation=~"get|list|listWithCount"}[${d_all}])) by (le))
${t_install} cluster:etcd:read:requests:latency:install:quantile histogram_quantile(0.99, sum(rate(etcd_request_duration_seconds_bucket{operation=~"get|list|listWithCount"}[${d_install}])) by (le))
${t_test}    cluster:etcd:read:requests:latency:test:quantile histogram_quantile(0.99, sum(rate(etcd_request_duration_seconds_bucket{operation=~"get|list|listWithCount"}[${d_test}])) by (le))
${t_all}     cluster:etcd:write:requests:latency:total:quantile histogram_quantile(0.99, sum(rate(etcd_request_duration_seconds_bucket{operation=~"create|update|delete"}[${d_all}])) by (le))
${t_install} cluster:etcd:write:requests:latency:install:quantile histogram_quantile(0.99, sum(rate(etcd_request_duration_seconds_bucket{operation=~"create|update|delete"}[${d_install}])) by (le))
${t_test}    cluster:etcd:write:requests:latency:test:quantile histogram_quantile(0.99, sum(rate(etcd_request_duration_seconds_bucket{operation=~"create|update|delete"}[${d_test}])) by (le))

${t_all}     cluster:etcd:read:requests:latency:total:avg sum(rate(etcd_request_duration_seconds_sum{operation=~"get|list|listWithCount"}[${d_all}])) / sum(rate(etcd_request_duration_seconds_count{operation=~"get|list|listWithCount"}[${d_all}]))
${t_install} cluster:etcd:read:requests:latency:install:avg sum(rate(etcd_request_duration_seconds_sum{operation=~"get|list|listWithCount"}[${d_install}])) / sum(rate(etcd_request_duration_seconds_count{operation=~"get|list|listWithCount"}[${d_install}]))
${t_test}    cluster:etcd:read:requests:latency:test:avg sum(rate(etcd_request_duration_seconds_sum{operation=~"get|list|listWithCount"}[${d_test}])) / sum(rate(etcd_request_duration_seconds_count{operation=~"get|list|listWithCount"}[${d_test}]))
${t_all}     cluster:etcd:write:requests:latency:total:avg sum(rate(etcd_request_duration_seconds_sum{operation=~"create|update|delete"}[${d_all}])) / sum(rate(etcd_request_duration_seconds_count{operation=~"create|update|delete"}[${d_all}]))
${t_install} cluster:etcd:write:requests:latency:install:avg sum(rate(etcd_request_duration_seconds_sum{operation=~"create|update|delete"}[${d_install}])) / sum(rate(etcd_request_duration_seconds_count{operation=~"create|update|delete"}[${d_install}]))
${t_test}    cluster:etcd:write:requests:latency:test:avg sum(rate(etcd_request_duration_seconds_sum{operation=~"create|update|delete"}[${d_test}])) / sum(rate(etcd_request_duration_seconds_count{operation=~"create|update|delete"}[${d_test}]))
