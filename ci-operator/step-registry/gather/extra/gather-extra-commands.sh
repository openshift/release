...
${t_test}    cluster:etcd:disk:wal:fsync:test:p99:quantile histogram_quantile(0.99, avg(irate(etcd_disk_wal_fsync_duration_seconds_bucket{job="etcd"}[${d_test}])))
${t_test}    cluster:etcd:disk:wal:fsync:test:p95:quantile histogram_quantile(0.95, avg(irate(etcd_disk_wal_fsync_duration_seconds_bucket{job="etcd"}[${d_test}])))
${t_test}    cluster:etcd:disk:wal:fsync:test:p50:quantile histogram_quantile(0.50, avg(irate(etcd_disk_wal_fsync_duration_seconds_bucket{job="etcd"}[${d_test}])))

${t_test}    cluster:etcd:disk:backend:commit:test:p99:quantile histogram_quantile(0.99, avg(rate(etcd_disk_backend_commit_duration_seconds_bucket{job=~".*etcd.*"}[${d_test}])))
${t_test}    cluster:etcd:disk:backend:commit:test:p95:quantile histogram_quantile(0.95, avg(rate(etcd_disk_backend_commit_duration_seconds_bucket{job=~".*etcd.*"}[${d_test}])))
${t_test}    cluster:etcd:disk:backend:commit:test:p50:quantile histogram_quantile(0.50, avg(rate(etcd_disk_backend_commit_duration_seconds_bucket{job=~".*etcd.*"}[${d_test}])))
