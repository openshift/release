...
${t_test}    cluster:etcd:disk:wal:fsync:test:p99:quantile avg(histogram_quantile(0.99, irate(etcd_disk_wal_fsync_duration_seconds_bucket{job="etcd"}[${d_test}])))
${t_test}    cluster:etcd:disk:wal:fsync:test:p95:quantile avg(histogram_quantile(0.95, irate(etcd_disk_wal_fsync_duration_seconds_bucket{job="etcd"}[${d_test}])))
${t_test}    cluster:etcd:disk:wal:fsync:test:p50:quantile avg(histogram_quantile(0.50, irate(etcd_disk_wal_fsync_duration_seconds_bucket{job="etcd"}[${d_test}])))
