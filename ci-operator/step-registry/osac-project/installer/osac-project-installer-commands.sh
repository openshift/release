...
-e INSTALLER_MCE_SERVICE=${MCE_SERVICE} \
-e INSTALLER_STORAGE_SERVICE=${STORAGE_SERVICE} \
-e INSTALLER_INGRESS_SERVICE=${INGRESS_SERVICE} \
-e INSTALLER_CLUSTER_TEMPLATE=${OSAC_CLUSTER_TEMPLATE} \
