...
git clone https://github.com/tanfengshuang/policy-collection.git -b fix-quay-acm-obs

cd policy-collection/deploy/ 
echo 'y' | ./deploy.sh -p policygenerator/policy-sets/community/openshift-plus-setup -n policies -u https://github.com/tanfengshuang/policy-collection.git -b fix-quay-acm-obs -a openshift-plus-setup
