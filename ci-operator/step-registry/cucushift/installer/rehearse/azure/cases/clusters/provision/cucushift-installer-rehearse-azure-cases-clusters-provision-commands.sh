...
function post_actions() {
  ...
  update_result "CNumber" "${COMPUTE_INSTANCE_TYPE_NUMBER}"
...
COMPUTE_INSTANCE_TYPE_NUMBER="$(jq -r '.CNumber' "${OUT_SELECT_DICT}")"
if ! is_empty "${COMPUTE_INSTANCE_TYPE_NUMBER}"; then
    IC_COMPUTE_NODE_COUNT=${COMPUTE_INSTANCE_TYPE_NUMBER}
fi
