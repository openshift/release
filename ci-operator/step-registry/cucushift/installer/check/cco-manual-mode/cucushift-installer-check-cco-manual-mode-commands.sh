...
# TODO: confirm the correct value for each versions
upgradeable=$(oc get clusteroperator/cloud-credential -o jsonpath='{.status.conditions[?(@.type=="Upgradeable")].status}')
echo "Cluster Upgradeable: ${upgradeable}"
