...
scl enable rh-ruby27 -- cucumber -p junit --tags "@smoke and not @admin and not @destructive"
#scl enable rh-ruby27 cucumber -p junit --tags "@admin and not @destructive"
#scl enable rh-ruby27 cucumber -p junit --tags "@destructive"
