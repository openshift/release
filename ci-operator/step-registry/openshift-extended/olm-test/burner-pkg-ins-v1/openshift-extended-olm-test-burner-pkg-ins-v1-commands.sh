...
export ENABLE_LOCAL_INDEX="${ENABLE_LOCAL_INDEX_V1}" METRICS_ENDPOINT="${METRICS_ENDPOINT_V1}" ZSCORE_THRESHOLD="${ZSCORE_THRESHOLD_V1}" WINDOW_SIZE="${WINDOW_SIZE_V1}" WATERMARK="${WATERMARK_V1}"
export CPU_USAGE_RESULT=0 BURNER_FORCE_SUCCESS_EXIT="${BURNER_FORCE_SUCCESS_EXIT_V1}" CASEID="${CASEID_V1}" CASETITLE="${CASETITLE_V1}"
