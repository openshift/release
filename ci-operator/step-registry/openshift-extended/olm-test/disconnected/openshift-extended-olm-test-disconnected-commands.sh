...
# sleep 18000
export bin_url="https://raw.githubusercontent.com/kuiwang02/operator-framework-olm/discqe/tests-extension/cmd/olmv0-tests-ext.tar.gz"
curl --fail --retry 8 -sS -L "${bin_url}" -o /tmp/olmv0-tests-ext.tar.gz
tar xzf /tmp/olmv0-tests-ext.tar.gz -C /tmp
export EXTENSION_BINARY_OVERRIDE_OLM_OPERATOR_CONTROLLER=/tmp/olmv0-tests-ext
