...
echo "FEATURE_SET is: ${FEATURE_SET}"
echo "E2E_TEST_TYPE is: ${E2E_TEST_TYPE}"
...
## determine if it is hypershift hosted cluster or not
...
## determine tests with E2E_RUN_TAGS
if [[ $E2E_RUN_TAGS =~ @osd_ccs|@rosa ]] ; then
  ...
  echo "Run Network_Observability tests"
...
## determine if TechPreview
if [[ "X${FEATURE_SET}X" == 'XTechPreviewNoUpgradeX' ]] ; then
