...
# The measurable run
EXTRA_FLAGS+=" --metrics-profile metrics.yml,cnv-metrics --gc-metrics=true --iteration=${ITERATIONS} --layer3=${ENABLE_L3} --vmi-ready-threshold=${VMI_READY_THRESHOLD}s --profile-type=${PROFILE_TYPE}"
