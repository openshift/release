...
# The measurable run
EXTRA_FLAGS+=" --metrics-profile metrics.yml,cnv-metrics --gc-metrics=true --vms-per-node=$VMS_PER_NODE --vmi-ready-threshold=${VMI_READY_THRESHOLD}s --profile-type=${PROFILE_TYPE} --burst=${BURST} --qps=${QPS}"
