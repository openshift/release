#!/bin/bash
#
# Create MTV NetworkMap and StorageMap for the return migration leg (spoke-2 → spoke-1) on the hub.
# Return-leg companion to p2p-mtv-create-migration-maps; map names carry a "-return" suffix.
