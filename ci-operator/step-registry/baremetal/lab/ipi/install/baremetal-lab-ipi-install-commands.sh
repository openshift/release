...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE="registry.build07.ci.openshift.org/ci-ln-7fmnq22/release:latest"
export MULTI_RELEASE_IMAGE="registry.build07.ci.openshift.org/ci-ln-7fmnq22/release:latest"
