...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE="registry.build10.ci.openshift.org/ci-ln-qiyhs7b/release:latest"
export MULTI_RELEASE_IMAGE="registry.build10.ci.openshift.org/ci-ln-qiyhs7b/release:latest"
