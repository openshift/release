...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRID=registry.build11.ci.openshift.org/ci-ln-sqtw0rt/release:latest
export MULTI_RELEASE_IMAGE=registry.build11.ci.openshift.org/ci-ln-sqtw0rt/release:latest
