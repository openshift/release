...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE="registry.build10.ci.openshift.org/ci-ln-6qhhrxk/release:latest"
export MULTI_RELEASE_IMAGE="registry.build10.ci.openshift.org/ci-ln-6qhhrxk/release:latest"
