...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE="registry.build11.ci.openshift.org/ci-ln-by6qhsk/release:latest"
export MULTI_RELEASE_IMAGE="registry.build11.ci.openshift.org/ci-ln-by6qhsk/release:latest"
