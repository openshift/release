...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE=registry.build06.ci.openshift.org/ci-ln-sk2g9pb/release:latest
export MULTI_RELEASE_IMAGE=registry.build06.ci.openshift.org/ci-ln-sk2g9pb/release:latest
