...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE="quay.io/openshift-release-dev/ocp-release:4.19.0-rc.2-multi"
export MULTI_RELEASE_IMAGE="quay.io/openshift-release-dev/ocp-release:4.19.0-rc.2-multi"
