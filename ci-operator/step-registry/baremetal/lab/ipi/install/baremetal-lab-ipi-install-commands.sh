...
export MULTI_RELEASE_IMAGE="registry.build05.ci.openshift.org/ci-ln-63i7b1b/release:latest"
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE="registry.build05.ci.openshift.org/ci-ln-63i7b1b/release:latest"
