...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE="registry.build10.ci.openshift.org/ci-ln-1xcxtxk/release:latest"
export MULTI_RELEASE_IMAGE="registry.build10.ci.openshift.org/ci-ln-1xcxtxk/release:latest"
