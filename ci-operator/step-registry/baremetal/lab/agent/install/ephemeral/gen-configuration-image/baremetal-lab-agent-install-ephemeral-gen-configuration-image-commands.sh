...
scp "${SSHOPTS[@]}" "${INSTALL_DIR}/${AGENT_CONFIGURATION_IMAGE_NAME}" "root@${AUX_HOST}:/mnt/data-storage/html/${CLUSTER_NAME}/${AGENT_CONFIGURATION_IMAGE_NAME}"
...
chmod 644 /mnt/data-storage/html/${CLUSTER_NAME}/*.iso
EOF
