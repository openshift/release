...
extended-platform-tests run all --dry-run | grep -E ${QUAY_OPERATOR_TESTCASE} | extended-platform-tests run --timeout 240m --max-parallel-tests 3 --junit-dir="${ARTIFACT_DIR}" -f - || true
