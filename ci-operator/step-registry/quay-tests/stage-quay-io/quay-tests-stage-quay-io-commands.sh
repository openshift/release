...
#    if [[ -e "./stage_quay_io_testing_report_before_format.xml" ]]; then
#        cp -r "./stage_quay_io_testing_report_before_format.xml" $ARTIFACT_DIR
#    fi
}
...
#reformat_report "stage_quay_io_testing_report.xml" "Quay New UI Testing" ||true 
