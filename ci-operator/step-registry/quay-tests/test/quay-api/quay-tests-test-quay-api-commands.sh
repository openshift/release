...
NO_COLOR=1 yarn run cypress run --spec "${CYPRESS_SPEC}" --browser chrome --headless --disable-popup-blocking --reporter cypress-multi-reporters --reporter-options configFile=reporter-config.json > \
