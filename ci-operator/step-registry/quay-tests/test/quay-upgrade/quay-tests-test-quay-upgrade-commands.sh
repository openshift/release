...
if [[ -n "${MULTISTAGE_PARAM_OVERRIDE_QUAY_OPERATOR_CHANNEL:-}" ]]; then
    QUAY_OPERATOR_CHANNEL="$MULTISTAGE_PARAM_OVERRIDE_QUAY_OPERATOR_CHANNEL"
fi
if [[ -n "${MULTISTAGE_PARAM_OVERRIDE_QUAY_VERSION:-}" ]]; then
    QUAY_VERSION="$MULTISTAGE_PARAM_OVERRIDE_QUAY_VERSION"
fi
if [[ -n "${MULTISTAGE_PARAM_OVERRIDE_QUAY_INDEX_IMAGE:-}" ]]; then
    QUAY_INDEX_IMAGE_BUILD="$MULTISTAGE_PARAM_OVERRIDE_QUAY_INDEX_IMAGE"
fi
