...
# QUAY_OPERATOR_TESTCASE="42374-Quay-High|42387-Quay-Medium|42396-Quay-High"
# extended-platform-tests run all --dry-run | grep -E ${QUAY_OPERATOR_TESTCASE} | extended-platform-tests run --timeout 150m --max-parallel-tests 1 --junit-dir="${ARTIFACT_DIR}" -f - || true
