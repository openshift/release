...
echo "************ image based install ztp preinstall host command ************"
...
sudo dnf -y install runc crun gcc-c++ zip nmstate
...
export SSH_FLAGS="-o IdentityFile=./bip-orchestrate-vm/ssh-key/key -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no"
