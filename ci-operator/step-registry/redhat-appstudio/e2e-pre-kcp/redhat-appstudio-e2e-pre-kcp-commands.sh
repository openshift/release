...
GITHUB_USER=$(cat /usr/local/konflux-ci-secrets/redhat-appstudio-qe/github-user)
GITHUB_TOKEN=$(cat /usr/local/konflux-ci-secrets/redhat-appstudio-qe/github-token)
