...
export DEFAULT_QUAY_ORG DEFAULT_QUAY_ORG_TOKEN GITHUB_USER GITHUB_TOKEN QUAY_TOKEN QUAY_OAUTH_USER QUAY_OAUTH_TOKEN OPENSHIFT_API OPENSHIFT_USERNAME OPENSHIFT_PASSWORD \
    ...
    GITLAB_BOT_TOKEN RELEASE_CATALOG_TA_QUAY_TOKEN SMEE_CHANNEL CODEBERG_BOT_TOKEN DOCKER_IO_AUTH
...
DOCKER_IO_AUTH=(cat /usr/local/konflux-ci-secrets-new/redhat-appstudio-qe/docker_io)
