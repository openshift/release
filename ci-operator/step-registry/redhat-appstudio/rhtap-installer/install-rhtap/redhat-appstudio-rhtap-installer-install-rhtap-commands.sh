...
RHTAP_ENABLE_GITHUB='true'
RHTAP_ENABLE_GITLAB='false'
RHTAP_ENABLE_DEVELOPER_HUB='true'
RHTAP_ENABLE_TAS='true'
RHTAP_ENABLE_TAS_FULCIO_OIDC_DEFAULT_VALUES='false'
