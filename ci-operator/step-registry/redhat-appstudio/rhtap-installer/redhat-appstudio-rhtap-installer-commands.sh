...
ACS_API_TOKEN=$(cat /usr/local/ci-secrets/redhat-appstudio-qe/acs-api-token)
ACS_CENTRAL_ENDPOINT=$(cat /usr/local/ci-secrets/redhat-appstudio-qe/acs-central-endpoint)
DEVELOPER_HUB_CATALOG_URL=https://github.com/redhat-appstudio/tssc-sample-templates/blob/main/all.yaml
GITHUB_APP_ID=$(cat /usr/local/ci-secrets/redhat-appstudio-qe/rhdh-github-app-id)
GITHUB_APP_CLIENT_ID=$(cat /usr/local/ci-secrets/redhat-appstudio-qe/dance-github-client-id)
GITHUB_APP_CLIENT_SECRET=$(cat /usr/local/ci-secrets/redhat-appstudio-qe/dance-github-client-id)
GITHUB_APP_WEBHOOK_SECRET=$(cat /usr/local/ci-secrets/redhat-appstudio-qe/dance-github-webhook-secret)
GITHUB_APP_WEBHOOK_URL=GITHUB_APP_WEBHOOK_URL
GITHUB_APP_PRIVATE_KEY=$(base64 -d < /usr/local/ci-secrets/redhat-appstudio-qe/dance-github-private-key)
