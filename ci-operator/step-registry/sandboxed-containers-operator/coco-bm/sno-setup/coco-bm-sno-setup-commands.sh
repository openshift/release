...
BASTION_IP=$(cat /usr/local/coco-bm-bastion-$BM_LAB/secrets/BASTION_IP)
BASTION_USER=$(cat /usr/local/coco-bm-bastion-$BM_LAB/secrets/BASTION_USER)
BASTION_LAB_INTERFACE=$(cat /usr/local/coco-bm-bastion-$BM_LAB/secrets/BASTION_LAB_INTERFACE)
BASTION_CONTROLPLANE_INTERFACE=$(cat /usr/local/coco-bm-bastion-$BM_LAB/secrets/BASTION_CONTROLPLANE_INTERFACE)
BASTION_BMC_ADDRESS=$(cat /usr/local/coco-bm-bastion-$BM_LAB/secrets/BASTION_BMC_ADDRESS)
BASTION_BMC_USER=$(cat /usr/local/coco-bm-bastion-$BM_LAB/secrets/BASTION_BMC_USER)
BASTION_PASSWORD=$(cat /usr/local/coco-bm-bastion-$BM_LAB/secrets/BASTION_PASSWORD)

SNO_CONTROLPLANE_LAB_INTERFACE=$(cat /usr/local/coco-bm-sno-$TEE_TYPE-$BM_LAB/secrets/SNO_CONTROLPLANE_LAB_INTERFACE)
SNO_BMC_ADDRESS=$(cat /usr/local/coco-bm-sno-$TEE_TYPE-$BM_LAB/secrets/SNO_BMC_ADDRESS)
SNO_MAC_ADDRESS=$(cat /usr/local/coco-bm-sno-$TEE_TYPE-$BM_LAB/secrets/SNO_MAC_ADDRESS)
SNO_IP_ADDRESS=$(cat /usr/local/coco-bm-sno-$TEE_TYPE-$BM_LAB/secrets/SNO_IP_ADDRESS)
SNO_VENDOR=$(cat /usr/local/coco-bm-sno-$TEE_TYPE-$BM_LAB/secrets/SNO_VENDOR)
SNO_INSTALL_DISK=$(cat /usr/local/coco-bm-sno-$TEE_TYPE-$BM_LAB/secrets/SNO_INSTALL_DISK)
SNO_BMC_USER=$(cat /usr/local/coco-bm-sno-$TEE_TYPE-$BM_LAB/secrets/SNO_BMC_USER)
SNO_BMC_PASSWORD=$(cat /usr/local/coco-bm-sno-$TEE_TYPE-$BM_LAB/secrets/SNO_BMC_PASSWORD)
...
[bastion]
${BASTION_IP} ansible_ssh_user=${BASTION_USER} bmc_address=${BASTION_BMC_ADDRESS} lab_ip=${BASTION_IP}
