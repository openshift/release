...
for master in "ci.openshift.redhat.com" "kata-jenkins-ci.westus2.cloudapp.azure.com"; do
	...
	oc label secret --overwrite "jenkins-credentials-${master}" "ci.openshift.io/managed=true"
done
...
for login in "openshift-bot" "openshift-build-robot" "openshift-cherrypick-robot" "openshift-ci-robot" "openshift-merge-robot" "openshift-publish-robot"; do
	...
	oc label secret --overwrite "github-credentials-${login}" "ci.openshift.io/managed=true"
done
...
oc label secret --overwrite "ci-chat-bot-slack-token" "ci.openshift.io/managed=true"
...
oc label secret --overwrite "github-app-credentials" "ci.openshift.io/managed=true"
...
oc label secret --overwrite "cookie" "ci.openshift.io/managed=true"
...
oc label secret --overwrite "github-webhook-credentials" "ci.openshift.io/managed=true"
...
oc label secret --overwrite "github-deploymentconfig-trigger" "ci.openshift.io/managed=true"
...
for registry in "docker.io" "quay.io"; do
	...
	oc label secret --overwrite "registry-push-credentials-${registry}" "ci.openshift.io/managed=true"
...
oc label secret --overwrite "cluster-secrets-${target_cloud}" "ci.openshift.io/managed=true"
