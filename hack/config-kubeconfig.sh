...
declare -A CONFIGS=(
    ...
    [build03]='RedHat_Internal_SSO ; default ; https://api.build03.ci.devcluster.openshift.com:6443'
    [build04]='RedHat_Internal_SSO ; default ; https://api.build04.gcp.ci.openshift.org:6443'
    [build05]='RedHat_Internal_SSO ; default ; https://api.build05.ci.devcluster.openshift.com:6443'
    ...
    [build08]='RedHat_Internal_SSO ; default ; https://api.build08.gcp.ci.openshift.org:6443'
    ...
    [build13]='RedHat_Internal_SSO ; default ; https://api.build13.gcp.ci.openshift.org:6443'
    [core-ci]='RedHat_Internal ; default ; https://api.master.ci.devcluster.openshift.com:6443'
...
if [[ $# -eq 0 ]] ; then
    ...
    for cluster in $@ ; do
        case $cluster in
            app.ci|core-ci|build01|build02|build03|build04|build05|build06|build07|build08|build09|build10|build11|build12|build13|vsphere02|hosted-mgmt)
