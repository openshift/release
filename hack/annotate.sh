...
for release in ${releases[@]}; do
	...
	# Match names generated by doozer's assembly_imagestream_base_name_generic().
	annotate "ocp" "${release}-art-assembly-konflux-rhcos" "konflux-ocp-${release}-rhcos.json"
	annotate "ocp-s390x" "${release}-art-assembly-konflux-rhcos-s390x" "konflux-ocp-${release}-rhcos-s390x.json"
	annotate "ocp-ppc64le" "${release}-art-assembly-konflux-rhcos-ppc64le" "konflux-ocp-${release}-rhcos-ppc64le.json"
	annotate "ocp-arm64" "${release}-art-assembly-konflux-rhcos-arm64" "konflux-ocp-${release}-rhcos-arm64.json"
