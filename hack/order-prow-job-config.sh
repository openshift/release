...
$cmd --prow-jobs-dir "${ci_operator_dir}/jobs" --config-path "${base_dir}/core-services/sanitize-prow-jobs/_config.yaml" --cluster-config-path "${base_dir}/core-services/sanitize-prow-jobs/_clusters.yaml"
