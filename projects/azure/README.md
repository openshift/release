...
team who is responsible for managing the OpenShift CI Infrastructure at [#forum-ocp-testplatform](https://coreos.slack.com/).
...
In general, all changes in `projects/azure/` are not automatically applied in the CI cluster. CI admins can be contacted at [#forum-ocp-testplatform](https://coreos.slack.com/). After your
