...
The `_config.yaml` file is used to mirror public images from various registries into [QCI](https://quay.io/repository/openshift/ci) and `registry.ci.openshift.org`,
